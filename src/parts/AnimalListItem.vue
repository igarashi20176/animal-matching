<template>
  <a class="block cursor-pointer" @click.prevent="showDetailItem(list.id)">
    <div class="relative m-6 p-2 border-2 rounded-2xl border-gray-400 bg-orange-100 hover:shadow-[0_0_8px_3px_rgba(0,0,0,0.3)] transition hover:translate-y-[-2px]">
      <figure class="flex">
        <img 
